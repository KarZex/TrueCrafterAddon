...
execute @s[scores={restore=20},tag=meleeu] ~~~ replaceitem entity @s slot.weapon.mainhand 0 golden_sword
execute @s[scores={restore=20},tag=rangedu] ~~~ replaceitem entity @s slot.weapon.mainhand 0 crossbow
...
execute @s[scores={antifire=20},tag=meleeu] ~~~ replaceitem entity @s slot.weapon.mainhand 0 golden_sword
execute @s[scores={antifire=20},tag=rangedu] ~~~ replaceitem entity @s slot.weapon.mainhand 0 crossbow
tag @s[scores={antifire=21..}] remove antifire
scoreboard players set @s[scores={antifire=21..}] antifire 0

execute @s[tag=angry] ~~~ execute @e[type=piglin,r=20,tag=!angry] ~~~ event entity @s important_block_destroyed_event
execute @s[tag=angry] ~~~ execute @e[type=piglin,r=20,tag=!angry] ~~~ playsound mob.piglin.angry @a ~~~
execute @s[tag=angry] ~~~ execute @e[type=piglin,r=20,tag=!angry] ~~~ particle minecraft:villager_angry ~~2~
execute @s[tag=angry] ~~~ execute @e[type=piglin,r=20,tag=!angry] ~~~ event entity @s very_angry
